...
public class Schema {
	...
	public static class Var {
		...
		public boolean equals(Var v) {
			return (rangeVariable == null || v.rangeVariable == null || rangeVariable
					.equals(v.rangeVariable)) && (name.equals(v.name));
		}
	...
	public static class Column {
		...
		public Column(String rangeVariable, String name, Type type) {
			this.name = new Var(rangeVariable, name);
			this.type = type;
		}
	...
	public static class TableFromFile extends Table {
		...
		public TableFromFile(File file) {
			super();
			this.file = file;
		}

		public TableFromFile(File file, Table t) {
			super(t);
			this.file = file;
		}
